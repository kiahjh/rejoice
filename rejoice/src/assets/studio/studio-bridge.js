...
document.addEventListener('mousemove', e => {
  ...
  post({ type: 'hover', rect: { left: r.left, top: r.top, width: r.width, height: r.height } });
}, true);
...
s.textContent = `html.studio-select, html.studio-select * { cursor: crosshair !important; }`;
